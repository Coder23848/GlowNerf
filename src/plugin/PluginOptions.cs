...
namespace GlowNerf
{
    public class PluginOptions : OptionInterface
    {
        ...
        public static Configurable<int> GlowFadeTime = Instance.config.Bind("GlowFadeTime", 10, new ConfigurableInfo("The number of cycles it takes to lose the glow effect.", new ConfigAcceptableRange<int>(1, 1000)));
        //public static Configurable<int> LanternFadeTime = Instance.config.Bind("LanternFadeTime", 10, new ConfigurableInfo("The number of cycles it takes for a lantern to die out.", new ConfigAcceptableRange<int>(1, 1000)));
